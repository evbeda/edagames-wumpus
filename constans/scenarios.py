...
c1p1 = Character(player_1)
c2p1 = Character(player_1)
c3p1 = Character(player_1)
pl_2 = Player(PLAYER_1)
c1p2 = Character(player_2)
c2p2 = Character(player_2)
c3p2 = Character(player_2)
BOARD_WITH_ONLY_CHARACTERS[0][0].character = c1p1
BOARD_WITH_ONLY_CHARACTERS[0][8].character = c2p1
BOARD_WITH_ONLY_CHARACTERS[0][16].character = c3p1
BOARD_WITH_ONLY_CHARACTERS[16][0].character = c1p2
BOARD_WITH_ONLY_CHARACTERS[16][8].character = c2p2
BOARD_WITH_ONLY_CHARACTERS[16][16].character = c3p2
